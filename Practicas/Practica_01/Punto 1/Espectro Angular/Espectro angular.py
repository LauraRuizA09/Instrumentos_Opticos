...
# ===================================================================
#                   Metodo del Espectro Angular
# ===================================================================

# ---------- Parámetros Físicos ----------

a = 2                      # Tamaño horizontal de la rendija en  mm
b = 3                       # Tamaño vertical de la rendija en mm
# z = 100                   # Se reemplaza valor fijo por entrada de usuario
...
# ===================================================================
#      Restricción para el valor de Z (Método Espectro Angular)
# ===================================================================
# De acuerdo con el material del curso (S07b - Límites de la difracción discreta),
# para que el muestreo del kernel de propagación del Espectro Angular sea adecuado
# y se evite el aliasing, la distancia de propagación z debe cumplir la siguiente condición:
# z <= (N * dx^2) / lambda
# Donde N es el número de muestras y dx es el paso espacial.

z_max = (Nx * dx**2) / lam_mm

# Se evalúa la condición. Si no se cumple, se muestra un aviso y el programa no continúa con el cálculo.
if z > z_max:
    print("\n¡ADVERTENCIA!")
    print(f"El valor de z = {z} mm no está permitido para los parámetros de muestreo actuales.")
    print(f"Para el método del Espectro Angular, z debe ser menor o igual a {z_max:.2f} mm.")
    print("Este límite asegura un muestreo adecuado del kernel de propagación y evita el 'aliasing'")
    ...
    A0_ = np.fft.fftshift(A0)                   # Organizamos el espectro de frecuencias para que la multiplicación por
                                                # la función de transferencia que la multiplicación por la función de transferencia
    ...
    # ===================================================================
    #               Solución Analítica (Integral de Fresnel)
    # ===================================================================
